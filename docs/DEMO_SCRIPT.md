...
Thao tác phụ (nếu còn thời lượng): mở **Học liệu**, sửa một dòng trong tài liệu "Phân số bằng
nhau" rồi bấm "Lưu và phát cho lớp" và nói:

> Tài liệu ôn tập là của chính cô: cô sửa, bấm lưu, và bản của cô được phát tới thiết bị của cả
> lớp — các em đọc được cả khi mất mạng, kèm dòng ghi công "Tài liệu do cô cập nhật".

Hoặc mở Giao bài, tạo bài giao nhanh cho nhóm.
