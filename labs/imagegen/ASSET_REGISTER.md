...
| N01 | Team-supplied NekoPath mark; `docs/BRAND_SYSTEM.md#2` | Product identity: shell, PWA icons, share card | in review | pending           | Preserve the supplied black feline silhouette; promote only a legible, local, versioned derivative. It is product identity, never a mascot or a learning-state icon.                                                                                                  |
